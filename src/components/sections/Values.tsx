    ...
    <section className="bg-tcl-white py-20 md:py-28 relative z-10">
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-16">
           <h2 className="font-oswald font-bold text-tcl-navy text-3xl uppercase inline-block border-b-4 border-tcl-gold pb-1">What We Stand For</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            >
              <div className="w-14 h-14 rounded-full bg-tcl-navy flex items-center justify-center mb-4 shadow-lg">
