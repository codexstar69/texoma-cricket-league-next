  ...
  return (
    <section id="tournaments" className="bg-tcl-white py-20 md:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 text-center mb-16 md:mb-20">
        <div className="w-16 h-1 bg-tcl-crimson mx-auto mb-4"></div>
        <span className="font-rajdhani font-bold text-tcl-navy uppercase tracking-widest text-sm block mb-2">Season Calendar</span>
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <motion.div
          ...
          className="hidden md:block absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-tcl-navy to-tcl-crimson origin-left z-0 -translate-y-1/2"
        />

        {/* Mobile Line */}
        <div className="md:hidden absolute top-0 left-[19px] bottom-0 w-1 bg-tcl-navy/30"></div>
            ...
            <div key={i} className="relative flex md:block md:h-[420px]">
              ...
              <motion.div
                ...
                className={`
                    ...
                    ${item.featured ? 'bg-tcl-crimson w-8 h-8 md:w-8 md:h-8' : 'bg-tcl-navy w-6 h-6 md:w-6 md:h-6'}
