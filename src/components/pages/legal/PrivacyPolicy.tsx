...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-4">
        Cricket Texoma (&ldquo;TCL&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) is a sports organization based at Sports Texoma, dedicated to promoting and organizing cricket tournaments across the Texoma region. We respect your privacy and are committed to protecting the personal information of our players, parents, coaches, and website visitors.
      </p>
      <p className="mb-4">
