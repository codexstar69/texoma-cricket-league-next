...
const Advantage = () => {
   return (
      <section className="bg-tcl-navy py-20 md:py-28 relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[55%_45%] gap-12 items-start">
               ...
               <div>
                  <div className="flex items-center gap-3 mb-4">
                     ...
                     <span className="font-barlow-condensed font-medium text-[13px] uppercase tracking-widest text-tcl-gold">The TCL Advantage</span>
                  </div>
                  <h2 className="font-barlow-condensed font-bold text-[44px] text-white uppercase mb-10">Why Academies Choose TCL</h2>
                  ...
                  <div className="space-y-6">
                     {[
                        ...
                        <motion.div
                           ...
                           className="pl-5 border-l-[3px] border-tcl-gold"
                        >
                           <p
                              className="font-source-sans text-[17px] text-white/90 leading-[1.7]"
               ...
               >
                  <img
                     ...
                     alt="Cricket Team"
                     className="rounded-2xl border border-white/10 shadow-2xl w-full aspect-[3/4] object-cover"
                  />
               </motion.div>
            </div>
            ...
            <div className="border-t border-white/10 pt-12">
               <div className="w-24 h-[1px] bg-tcl-gold mb-8"></div>

               <div className="mb-8">
                  <h3 className="font-barlow-condensed font-semibold text-[20px] text-tcl-gold uppercase mb-1">What Your Fees Pay For</h3>
                  <p className="font-source-sans text-[15px] text-white/70 italic">Annual membership, not individual event fees</p>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
                  {[
                     ...
                     >
                        <CheckCircle2 className="w-5 h-5 text-tcl-gold shrink-0 mt-0.5" />
                        <span className="font-source-sans text-[15px] text-white/85 leading-snug">{item}</span>
                     </motion.div>
                  ))}
               </div>
            </div>
