...
const tiers = [
  {
    ...
    price: "$2,500",
    color: "border-t-tcl-gold",
    badge: "Most Popular",
    badgeColor: "bg-tcl-gold text-tcl-navy",
    features: [
    ...
    <section id="pricing" className="bg-tcl-off-white py-28 md:py-32 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
         <div className="text-center mb-16">
            <span className="font-barlow-condensed font-medium text-[13px] text-tcl-gold uppercase tracking-widest block mb-2">Membership</span>
