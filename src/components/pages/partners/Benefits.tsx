         ...
         <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="mb-12 md:mb-16">
               <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-barlow-condensed font-medium text-[13px] uppercase tracking-widest text-tcl-navy">Partnership Benefits</span>
               </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
               ...
               >
                  <div className="absolute top-0 right-0 w-64 h-64 bg-tcl-crimson/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>

                  <div className="w-20 h-20 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                     <CalendarCheck className="w-10 h-10 text-tcl-crimson stroke-[1.5px]" />
                  </div>
               ...
               {[
                  ...
                  >
                     <div className="w-14 h-14 rounded-xl bg-tcl-navy/5 flex items-center justify-center mb-6 group-hover:bg-tcl-crimson/10 transition-colors">
                        <item.icon className="w-8 h-8 text-tcl-navy stroke-[2px] group-hover:text-tcl-crimson transition-colors" />
                     </div>
