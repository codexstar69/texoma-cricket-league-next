...
const Hero = () => {
  return (
    <section className="relative min-h-[50vh] md:min-h-[60vh] flex items-center bg-white overflow-hidden pt-44 pb-24 md:pt-52 md:pb-36 border-b border-tcl-light-gray">
      {/* Background Texture */}
      ...
      <div className="absolute inset-0 z-0 bg-radial-gradient from-tcl-off-white to-transparent pointer-events-none"></div>
      ...
      <div className="max-w-7xl w-full mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-[60%_40%] gap-12 items-center relative z-10">
        ...
        <div className="flex flex-col items-start text-left pt-10 md:pt-0">
          {/* Breadcrumb */}
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 font-source-sans text-[13px] font-medium text-tcl-navy/50 mb-6">
            <Link href="/" className="hover:text-tcl-navy transition-colors">Home</Link>
            <span aria-hidden="true">/</span>
            <span aria-current="page" className="text-tcl-navy">Tournaments</span>
          </nav>
          ...
          >
            ...
            <span className="font-barlow-condensed font-medium text-[13px] uppercase tracking-widest text-tcl-navy">Tournaments</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-barlow-condensed font-bold text-[42px] sm:text-[52px] md:text-[64px] leading-none text-tcl-navy uppercase tracking-wide mb-6"
          >
            Tournament Calendar
          </motion.h1>
          ...
          <motion.p
            ...
            className="font-source-sans text-lg md:text-xl font-normal text-tcl-navy/80 leading-relaxed max-w-[580px]"
          >
