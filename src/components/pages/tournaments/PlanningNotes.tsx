      ...
      <section className="bg-tcl-off-white pb-20 md:pb-24">
         <div className="max-w-4xl mx-auto px-4">
            <motion.div
               ...
               viewport={{ once: true }}
               className="bg-tcl-warm-stone/40 border-l-[4px] border-l-tcl-crimson rounded-xl p-8 shadow-sm"
            >
               <div className="flex items-center gap-3 mb-6">
                  <FileText className="w-[22px] h-[22px] text-tcl-crimson" />
               ...
               <ul className="space-y-3">
                  {[
                     ...
                     >
                        <CheckCircle2 className="w-4 h-4 text-tcl-crimson mt-1 shrink-0" />
